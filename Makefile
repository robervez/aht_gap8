...
MODEL_ID?=99
IMAGE?=$(CURDIR)/images/sample_image_320_256.ppm
...
APP = imagenet
MAIN ?= main_aht.c MultiRadio_AHT.c MultiRadio_library.c RVhelpers.c  img2jpg.c MultiRadio_Callback.c
...
APP_CFLAGS += -DAT_IMAGE=$(IMAGE) -DPERF=$(PERF)  -DMODEL_ID=$(MODEL_ID) -DFREQ_FC=$(FREQ_FC) -DFREQ_CL=$(FREQ_CL)
